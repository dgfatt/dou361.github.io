---
title: Android 基础
date: 2017-01-22 00:14:39
categories: java
tags: java

---
推荐文章  [Android 基础](http://eddy.wiki/interview-android.html)
...
* [intentService作用是什么，AIDL解决了什么问题？](#intentService作用是什么,AIDL解决了什么问题)
* [Activity,Window,View三者的差别，fragment的特点？](#Activity,Window,View三者的差别,fragment的特点)
* [描述一次网络请求的流程](#描述一次网络请求的流程)
* [Handler、Thread和HandlerThread的差别](#Handler,Thread和HandlerThread的差别)
* [低版本SDK实现高版本api](#低版本SDK实现高版本api)
* [Ubuntu编译安卓系统](#Ubuntu编译安卓系统)
* [launch mode应用场景](#LaunchMode应用场景)
* [Touch事件传递流程](#Touch事件传递流程)
* [view绘制流程](#View绘制流程)
* [多线程](#多线程)
* [线程同步](#线程同步)
* [什么情况导致内存泄漏](#什么情况导致内存泄漏)
* [ANR定位和修正](#ANR定位和修正)
* [什么情况导致oom](#什么情况导致oom)
* [Android Service与Activity之间通信的几种方式](#Service与Activity之间通信的几种方式)
* [Android各个版本API的区别](#Android各个版本API的区别)
* [Android代码中实现WAP方式联网](#Android代码中实现WAP方式联网)
* [如何保证service在后台不被kill](#如何保证service在后台不被Kill)
* [Requestlayout，onlayout，onDraw，DrawChild区别与联系](#Requestlayout,onlayout,onDraw,DrawChild区别与联系)
* [invalidate()和postInvalidate() 的区别及使用](#invalidate()和postInvalidate()的区别及使用)
* [Android动画框架实现原理](#Android动画框架实现原理)
* [Android为每个应用程序分配的内存大小是多少？](#Android为每个应用程序分配的内存大小是多少？)
* [Android View刷新机制](#View刷新机制)
* [LinearLayout对比RelativeLayout](#LinearLayout和RelativeLayout性能对比)
* [优化自定义view](#优化自定义view)
